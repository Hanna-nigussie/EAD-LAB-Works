    ...
    private void displayEditForm(int id, PrintWriter pw) throws SQLException, ClassNotFoundException {
        try (Connection con = manager.openConnection();
            ...
            if (rs.next()) {
                ...
                pw.println("<tr><td>Title</td><td><input type='text' name='title' value='" + rs.getString(1) + "'></td></tr>");
                pw.println("<tr><td>Author</td><td><input type='text' name='author' value='" + rs.getString(2) + "'></td></tr>");
                pw.println("<tr><td>Price</td><td><input type='text' name='price' value='" + rs.getFloat(3) + "'></td></tr>");
